...
local VROverrideSettings =
{
	RegularFont = Enum.Font.SourceSansBold;
	LightFont = Enum.Font.SourceSansBold;
	BoldFont = Enum.Font.SourceSansBold;
	ItalicFont = Enum.Font.SourceSansBold;
}

if Utility.ShouldUseVRAppLobby() then
	for key, value in pairs(VROverrideSettings) do
		Settings[key] = value
	end
end
